...
/**
 * Domolux checkbox component
 *
 * @element ha-checkbox
 * @extends {WaCheckbox}
 *
 * @summary
 * A Domolux themed wrapper around the Web Awesome checkbox.
 *
...
export class HaCheckbox extends WaCheckbox {
   ...
   * form submission rules. Domolux components expect the configured value
