import type { EntityVoiceAssistantFilter } from "../common/entity/entity_voice_assistant_filter";
...
export interface CloudStatusLoggedIn {
  ...
  google_entities: EntityVoiceAssistantFilter;
  google_domains: string[];
  alexa_registered: boolean;
  alexa_entities: EntityVoiceAssistantFilter;
