...
class HaWeatherCard extends LocalizeMixin(EventsMixin(PolymerElement)) {
  ...
  constructor() {
    ...
    this.weatherIcons = {
      ...
      "partlycloudy-night": "hass:weather-night-partly-cloudy",
      "partlysnowy-rainy": "hass:weather-partly-snowy-rainy",
      "partly-lightning": "hass:weather-partly-lightning",
      "partly-rainy": "hass:weather-partly-rainy",
      "partly-snowy": "hass:weather-partly-snowy",
      pouring: "hass:weather-pouring",
      rainy: "hass:weather-rainy",
      snowy: "hass:weather-snowy",
      "snowy-heavy": "hass:weather-snowy-heavy",
