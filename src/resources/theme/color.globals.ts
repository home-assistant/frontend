...
import { DEFAULT_ACCENT_COLOR, DEFAULT_PRIMARY_COLOR } from "../styles-data";
...
export const colorStyles = result.css;
export const colorDerivedVariables = result.derivedVariables;
