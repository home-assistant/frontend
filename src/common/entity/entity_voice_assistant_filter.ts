...
export type VoiceAssistantFilterFunc = (entityId: string) => boolean;

export interface EntityVoiceAssistantFilter {
...
export const isEmptyVoiceAssistantFilter = (
  filter: EntityVoiceAssistantFilter
) =>
...
export const generateVoiceAssistantFilter = (
