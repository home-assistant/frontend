...
class DialogNewInput extends LitElement implements HassDialog {
        ...
        },
        {
          ...
          options: [
            [
              "input",
              this.hass.localize(
                "ui.panel.config.developer-tools.tabs.blueprints.editor.inputs.type.new.input"
              ),
            ],
            [
              "section",
              this.hass.localize(
                "ui.panel.config.developer-tools.tabs.blueprints.editor.inputs.type.new.section"
              ),
            ],
          ],
        },
  ...
  private _computeLabel = (
    ...
    this.hass.localize(
      `ui.panel.config.developer-tools.tabs.blueprints.editor.inputs.type.new.${schema.name}`
    );
