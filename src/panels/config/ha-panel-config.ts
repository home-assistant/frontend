...
export const configSections: Record<string, PageNavigation[]> = {
  dashboard: [
    {
      ...
      iconPath: mdiDevices,
      iconColor: "var(--config-icon-integrations-color, #0D47A1)",
      core: true,
    },
    {
      ...
      iconPath: mdiRobot,
      iconColor: "var(--config-icon-automation-color, #518C43)",
      core: true,
    },
    {
      path: "/config/areas",
      ...
      iconPath: mdiSofa,
      iconColor: "var(--config-icon-areas-color, #E48629)",
      component: "zone",
    },
    {
      path: "/config/apps",
      ...
      iconPath: mdiPuzzle,
      iconColor: "var(--config-icon-apps-color, #F1C447)",
      component: "hassio",
    },
    {
      ...
      iconColor: "var(--config-icon-dashboards-color, #B1345C)",
      component: "lovelace",
    },
    {
      ...
      iconColor: "var(--config-icon-voice_assistants-color, #3263C3)",
    },
  ],
  dashboard_external_settings: [
    {
      ...
      iconColor: "var(--config-icon-companion-color, #8E24AA)",
    },
  ],
  dashboard_2: [
    {
      ...
      iconColor: "var(--config-icon-matter-color, #2458B3)",
      component: "matter",
    ...
    },
    {
      ...
      name: "Zigbee",
      iconPath: mdiZigbee,
      iconColor: "var(--config-icon-zigbee-color, #E74011)",
      component: "zha",
      translationKey: "zha",
    },
    {
      ...
      name: "Z-Wave",
      iconPath: mdiZWave,
      iconColor: "var(--config-icon-z-wave-color, #153163)",
      component: "zwave_js",
    ...
    },
    {
      ...
      iconColor: "var(--config-icon-knx-color, #4EAA66)",
      component: "knx",
      translationKey: "knx",
    },
    {
      ...
      iconColor: "var(--config-icon-thread-color, #ED7744)",
      component: "thread",
    ...
    },
    {
      ...
      iconColor: "var(--config-icon-bluetooth-color, #0082FC)",
      component: "bluetooth",
    ...
    },
    {
      ...
      iconColor: "var(--config-icon-insteon-color, #E4002C)",
      component: "insteon",
    ...
    },
    {
      ...
      iconColor: "var(--config-icon-tags-color, #616161)",
      component: "tag",
    },
  ],
  dashboard_3: [
    {
      ...
      iconPath: mdiAccount,
      iconColor: "var(--config-icon-people-color, #5A87FA)",
    ...
    },
    {
      ...
      iconPath: mdiCog,
      iconColor: "var(--config-icon-system-color, #301ABE)",
      core: true,
    },
    {
      ...
      iconPath: mdiHammer,
      iconColor: "var(--config-icon-developer_tools-color, #7A5AA6)",
      core: true,
    },
    {
      path: "/config/info",
      ...
      iconColor: "var(--config-icon-about-color, #4A5963)",
      core: true,
    },
  ],
  backup: [
    {
      ...
      iconColor: "var(--config-icon-backup-color, #4084CD)",
      component: "backup",
    },
  ],
  devices: [
    {
      ...
      iconPath: mdiPuzzle,
      iconColor: "var(--config-icon-integrations-color, #2D338F)",
      core: true,
    },
    {
      component: "devices",
      ...
      iconPath: mdiDevices,
      iconColor: "var(--config-icon-devices-color, #2D338F)",
      core: true,
    },
    {
      component: "entities",
      ...
      iconPath: mdiShape,
      iconColor: "var(--config-icon-entities-color, #2D338F)",
      core: true,
    },
    {
      component: "helpers",
  ...
  automations: [
    ...
    },
    {
      ...
      iconPath: mdiPalette,
      iconColor: "var(--config-icon-scene-color, #518C43)",
    },
    {
      component: "script",
      path: "/config/script",
      ...
      iconColor: "var(--config-icon-script-color, #518C43)",
    },
    {
      component: "blueprint",
      ...
      iconColor: "var(--config-icon-blueprint-color, #518C43)",
    },
  ],
  tags: [
    {
  ...
  energy: [
    {
      ...
      iconColor: "var(--config-icon-energy-color, #F1C447)",
    },
  ],
  lovelace: [
    {
      ...
      iconPath: mdiViewDashboard,
      iconColor: "var(--config-icon-lovelace-color, #B1345C)",
    },
  ],
  persons: [
    {
      ...
      iconPath: mdiAccount,
      iconColor: "var(--config-icon-person-color, #5A87FA)",
    },
    {
      component: "users",
      path: "/config/users",
      ...
      iconColor: "var(--config-icon-users-color, #5A87FA)",
      core: true,
      advancedOnly: true,
    },
  ],
  areas: [
    {
      ...
      iconPath: mdiSofa,
      iconColor: "var(--config-icon-areas-color, #2D338F)",
      core: true,
    },
    {
      component: "labels",
      ...
      iconPath: mdiLabel,
      iconColor: "var(--config-icon-labels-color, #2D338F)",
      core: true,
    },
    {
      component: "zone",
      ...
      iconColor: "var(--config-icon-zone-color, #E48629)",
    },
  ],
  general: [
    {
      ...
      translationKey: "core",
      iconPath: mdiCog,
      iconColor: "var(--config-icon-core-color, #653249)",
      core: true,
    },
    {
      path: "/config/updates",
      ...
      iconPath: mdiUpdate,
      iconColor: "var(--config-icon-updates-color, #3B808E)",
    },
    {
      path: "/config/repairs",
      translationKey: "repairs",
      iconPath: mdiScrewdriver,
      iconColor: "var(--config-icon-repairs-color, #5c995c)",
    },
    {
      component: "logs",
      path: "/config/logs",
      ...
      iconColor: "var(--config-icon-logs-color, #C65326)",
      core: true,
    },
    {
      path: "/config/backup",
      ...
      iconPath: mdiBackupRestore,
      iconColor: "var(--config-icon-backup-color, #0D47A1)",
      component: "backup",
    },
    {
      ...
      iconPath: mdiShape,
      iconColor: "var(--config-icon-analytics-color, #f1c447)",
    },
    {
      path: "/config/labs",
      translationKey: "labs",
      iconPath: mdiFlask,
      iconColor: "var(--config-icon-labs-color, #b1b134)",
      core: true,
    },
    {
      path: "/config/network",
      ...
      iconPath: mdiNetwork,
      iconColor: "var(--config-icon-network-color, #B1345C)",
    },
    {
      path: "/config/storage",
      translationKey: "storage",
      iconPath: mdiDatabase,
      iconColor: "var(--config-icon-storage-color, #518C43)",
      component: "hassio",
    },
    {
      ...
      iconPath: mdiMemory,
      iconColor: "var(--config-icon-hardware-color, #301A8E)",
  ...
  about: [
    {
      ...
      iconColor: "var(--config-icon-information-color, #4A5963)",
      core: true,
    },
  ],
};
