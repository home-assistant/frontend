...
class DialogInsteonProperty extends LitElement {
  ...
  @internalProperty() private _callback?: (name: string, value: any) => Promise<void>;

  @internalProperty() private _formData = { };

  public async showDialog(
    params: InsteonPropertyDialogParams
  ): Promise<void> {
  ...
  private _changeMade(): boolean {
    return (
      this._record!.value !== (this._formData[this._record!.name])
    );
  }
