import { mdiCloud, mdiPackageVariant, mdiSyncOff, mdiTrophy } from "@mdi/js";
  ...
  protected render(): TemplateResult {
    ...
    if (this.manifest) {
      ...
      if (
        ...
        this.manifest.quality_scale === "platinum"
      ) {
        icons.push([
          mdiTrophy,
          this.hass.localize(
            "ui.panel.config.integrations.config_entry.platinum_quality_scale"
          ),
        ]);
      }
    }
