...
@customElement("ha-pick-user-dashboard-row")
class HaPickUserDashboardRow extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    return html`
      <ha-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${this.hass.localize("ui.panel.profile.user-dashboard.header")}
        </span>
        <span slot="description">
          ${this.hass.localize("ui.panel.profile.user-dashboard.description")}
        </span>
        ${this._dashboards
          ? html`
              <ha-select
...
declare global {
  interface HTMLElementTagNameMap {
    "ha-pick-user-dashboard-row": HaPickUserDashboardRow;
  }
}
