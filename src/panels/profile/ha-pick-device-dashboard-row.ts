...
@customElement("ha-pick-device-dashboard-row")
class HaPickDeviceDashboardRow extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    return html`
      <ha-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${this.hass.localize("ui.panel.profile.device-dashboard.header")}
        </span>
        <span slot="description">
          ${this.hass.localize("ui.panel.profile.device-dashboard.description")}
        </span>
        ${this._dashboards
          ? html`
              <ha-select
...
declare global {
  interface HTMLElementTagNameMap {
    "ha-pick-device-dashboard-row": HaPickDeviceDashboardRow;
  }
}
