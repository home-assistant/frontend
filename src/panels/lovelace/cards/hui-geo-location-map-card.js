...
class HuiGeoLocationMapCard extends PolymerElement {
  static get template() {
    return html`
      <style>
  ...
  _drawEntities(hass) {
    ...
    this._configEntities = this._configEntities.concat(
      processConfigEntities(geoLoctionEntities)
    );
...
customElements.define("hui-geo-location-map-card", HuiGeoLocationMapCard);
