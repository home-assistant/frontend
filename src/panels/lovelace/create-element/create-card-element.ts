...
const LAZY_LOAD_TYPES = {
  ...
  "energy-carbon-emissions-gauge": () =>
    import("../cards/energy/hui-energy-carbon-emissions-gauge-card"),
  ...
  "energy-carbon-emissions-table": () =>
    import("../cards/energy/hui-energy-carbon-emissions-table-card"),
  "energy-usage-graph": () =>
