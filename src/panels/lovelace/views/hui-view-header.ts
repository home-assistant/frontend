...
export class HuiViewHeader extends LitElement {
  ...
  static styles = css`
    ...
    .layout.badges-scroll hui-view-badges {
      --badges-wrap: nowrap;
      --badges-aligmnent: flex-start;
    }

    .layout.center.badges-scroll hui-view-badges {
    ...
    @media (min-width: 768px) {
      ...
      .layout.responsive.badges-scroll.has-heading hui-view-badges {
        --badges-aligmnent: flex-start;
      }
