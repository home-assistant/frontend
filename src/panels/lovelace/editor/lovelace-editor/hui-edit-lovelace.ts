...
export class HuiEditLovelace extends hassLocalizeLitMixin(LitElement) {
  ...
  public async showDialog(): Promise<void> {
    ...
    const { views, ...lovelaceConfig } = this.lovelace!.config;
...
declare global {
  interface HTMLElementTagNameMap {
    "hui-edit-lovelace": HuiEditLovelace;
  }
}

customElements.define("hui-edit-lovelace", HuiEditLovelace);
