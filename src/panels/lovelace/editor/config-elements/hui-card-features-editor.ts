...
import { supportsLightBrightnessFavoritesCardFeature } from "../../card-features/hui-light-brightness-favorites-card-feature";
...
> = {
  ...
  "light-brightness-favorites": supportsLightBrightnessFavoritesCardFeature,
