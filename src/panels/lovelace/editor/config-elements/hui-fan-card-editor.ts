...
import { FanCardConfig } from "../../cards/types";
...
@customElement("hui-fan-card-editor")
export class HuiFanCardEditor extends LitElement implements LovelaceCardEditor {
...
declare global {
  interface HTMLElementTagNameMap {
    "hui-fan-card-editor": HuiFanCardEditor;
  }
}
