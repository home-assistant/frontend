...
// that other sites can embed the cards. Only the modern build is a module
// with `import.meta.url`. The legacy build only runs on the demo site, where
// the default paths are correct.
