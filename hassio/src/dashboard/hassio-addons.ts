...
const installedAddons = memoizeOne((addons: HassioAddonInfo[]) =>
  addons
    ...
    return html`
      <div class="content">
        ...
        <div class="card-group">
          ${!installedAddons(this.supervisor.addon.addons).length
            ? html`
                <ha-card outlined>
              ...
              `
            : installedAddons(this.supervisor.addon.addons).map(
                (addon) => html`
